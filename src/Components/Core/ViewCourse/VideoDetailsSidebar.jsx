...
const VideoDetailsSidebar=({setReviewModal})=>{
    ...
    return (
        <>
            <div className="flex h-[calc(100vh-3.5rem)] w-[320px] max-w-[350px] flex-col border-r-[1px] border-richblack-700 bg-richblack-800">
                    ...
                    {courseSectionData?.map((section,index)=>(
                        ...
                        >   
                            ...
                            {activeStatus===section?._id && (
                                <div className="transition-[height] duration-500n ease-in-out">
