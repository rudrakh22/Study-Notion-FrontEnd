...
import StatsContent from "../Components/Core/About/StatsContent"
        ...
        <div className="mt-14">
            ...
            <section className="bg-richblack-700">
                <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white ">
                    <header className="text-4xl mx-auto py-20 font-semibold lg:w-[70%]">
                        Driving Innovation in Online Education for a <HighlightText text="Brighter Future"/>
                        <p className="mx-auto mt-3 text-richblack-300 font-medium text-center lg:w-[95%] text-base">Studynotion is at the forefront of driving innovation in online education. We're passionate about creating a brighter future by offering cutting-edge courses, leveraging emerging technologies, and nurturing a vibrant learning community.
                        </p>
                    </header>
                    <div className="sm:h-[70px] lg:h-[150px]"></div>
                    <div className="absolute bottom-0 translate-y-[30%] w-[100%] grid grid-cols-3 lg:gap-5 gap-3 ">
            ...
            {/* section 3 */}
            <section >
                <div className="w-11/12 flex flex-col max-w-maxContent justify-between gap-10 text-richblack-500 mx-auto">
                    {/* upper box */}
                    <div className="flex lg:flex-row flex-col items-center justify-between gap-10">
                        {/* left */}
                        <div className="my-24 flex lg:w-[50%] flex-col gap-10">
                            <h1
                            className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl text-transparent font-semibold lg:w-[70%]"
                    ...
                    {/* lower box */}
                    <div className="flex flex-col items-center lg:flex-row lg:gap-10 justify-between">
                        ...
                        <div className="my-24 flex lg:w-[40%] flex-col gap-10">
                            <h1 className="bg-gradient-to-b from-[#1FA2FF] via-[#12D8FA] to-[#A6FFCB] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]">Our Mission</h1>
            ...
            <StatsContent/>
            {/* section 5 */}
            <section className="mt-20 w-11/12 mx-auto max-w-maxContent justify-between gap-10 text-white flex flex-col">
                <LearningGrid/>
                <ContactFormSection/>
            </section>
            {/* section 6 */}
            <section className="relative mx-auto my-20 flex w-11/12 flex-col items-center justify-between max-w-maxContent gap-8 bg-richblack-900 text-white">
                <h1
